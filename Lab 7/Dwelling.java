...
public abstract class Dwelling {
    ...
    */
    ...
    public void getSmallestRoom() {
        ...
        for (int x = 0; x < roomList.length; x++) {
            int roomArea = roomList[x].calcArea();
            if (roomArea > smallestRoomArea) {
                smallestRoomIndex = x;
                smallestRoomArea = roomArea;
            }
        }
        
        System.out.printf("The smallest room at %s\n", address);
        System.out.printf("is room %s\n", smallestRoomIndex);
    }
